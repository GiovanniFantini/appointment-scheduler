        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Recurrence = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_Merchants_MerchantId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MerchantRoles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MerchantRoles_Merchants_MerchantId",
                        column: x => x.MerchantId,
                        principalTable: "Merchants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeMemberships_MerchantRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "MerchantRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmployeeMemberships_Merchants_MerchantId",
                        column: x => x.MerchantId,
                        principalTable: "Merchants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoleFeatures_MerchantRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "MerchantRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeMemberships_EmployeeId_MerchantId",
                table: "EmployeeMemberships",
                columns: new[] { "EmployeeId", "MerchantId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeMemberships_MerchantId",
                table: "EmployeeMemberships",
                column: "MerchantId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeMemberships_RoleId",
                table: "EmployeeMemberships",
                column: "RoleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_MerchantId",
                table: "Events",
                column: "MerchantId");

            migrationBuilder.CreateIndex(
                name: "IX_Events_MerchantId_StartDate",
                table: "Events",
                columns: new[] { "MerchantId", "StartDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MerchantRoles_MerchantId",
                table: "MerchantRoles",
                column: "MerchantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleFeatures_RoleId_Feature",
                table: "RoleFeatures",
