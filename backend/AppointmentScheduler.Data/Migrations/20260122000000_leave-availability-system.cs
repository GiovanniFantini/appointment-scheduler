...
{
    /// <inheritdoc />
    public partial class leaveavailabilitysystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DaysRequested = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LeaveRequests_Merchants_MerchantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequests_MerchantId",
                table: "LeaveRequests",
                column: "MerchantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeLeaveBalances_EmployeeId_LeaveType_Year",
