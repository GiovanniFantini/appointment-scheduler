...
public interface IAuthService
{
    ...
    string GenerateJwtToken(int userId, string email, string role, int? merchantId = null, int? employeeId = null, List<string>? features = null, List<string>? featureLevels = null, bool merchantApproved = false);
}
