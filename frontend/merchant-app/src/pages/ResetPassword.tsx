        ...
        <div className="glass-card rounded-3xl p-8 shadow-glow-cyan border border-white/10">
          ...
          {success ? (
            <div className="text-center space-y-4">
              ...
              <Link to="/login" className="block text-neon-cyan hover:text-neon-green transition-colors text-sm">
                Vai al login ora
              </Link>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-neon-green to-neon-cyan text-dark-bg py-3.5 rounded-xl font-semibold hover:shadow-glow-cyan transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? 'Salvataggio...' : 'Salva nuova password'}
              </button>

              <div className="text-center">
                <Link to="/login" className="text-neon-cyan hover:text-neon-green transition-colors text-sm">
                  Torna al login
                </Link>
              </div>
            </form>
