          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              {user.role === 'Admin' && (
                <Link
                  to="/admin"
                  className="bg-gradient-to-r from-neon-purple to-neon-pink text-white px-4 py-2 rounded-xl hover:shadow-glow-purple transition-all font-semibold transform hover:scale-105 flex items-center gap-2"
                >
