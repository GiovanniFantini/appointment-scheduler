...
function Login({ onLogin }: LoginProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await apiClient.post('/employeeauth/login', { email, password })
      ...
      <div className="relative z-10 w-full max-w-md mx-4 animate-scale-in">
        <div className="glass-card rounded-3xl p-8 shadow-glow-cyan border border-white/10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">Accedi alla tua area dipendente</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-end mt-1">
                <Link to="/forgot-password" className="text-sm text-neon-cyan hover:text-neon-green transition-colors">
