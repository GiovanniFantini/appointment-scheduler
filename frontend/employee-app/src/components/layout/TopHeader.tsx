      ...
      <div className="px-4 lg:px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:block">
            {pageTitle ? (
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-lg font-bold gradient-text">Dashboard Dipendenti</span>
              </div>
            )}
          </div>
          ...
          <div className="lg:hidden flex items-center gap-2">
            ...
            <span className="font-bold gradient-text">Area Dipendenti</span>
          </div>
              ...
              <div className="glass-card px-4 py-2 rounded-xl border border-neon-cyan/20">
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-xs text-gray-400">{user.role || 'Dipendente'}</p>
                  </div>
                </div>
              </div>
            </div>
