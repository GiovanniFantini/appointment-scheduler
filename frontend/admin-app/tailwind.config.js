  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-neon': 'linear-gradient(135deg, #b24bf3 0%, #ff2e97 100%)',
        'gradient-dark': 'linear-gradient(180deg, #0a0a0f 0%, #1a1a24 100%)',
        'gradient-mesh': 'radial-gradient(at 40% 20%, #667eea 0px, transparent 50%), radial-gradient(at 80% 0%, #b24bf3 0px, transparent 50%), radial-gradient(at 0% 50%, #ff2e97 0px, transparent 50%)',
      },
      boxShadow: {
      ...
      keyframes: {
        ...
        glow: {
          '0%': { boxShadow: '0 0 5px rgba(178, 75, 243, 0.5), 0 0 20px rgba(178, 75, 243, 0.3)' },
          '100%': { boxShadow: '0 0 20px rgba(178, 75, 243, 0.8), 0 0 40px rgba(178, 75, 243, 0.5)' },
        },
        slideUp: {
